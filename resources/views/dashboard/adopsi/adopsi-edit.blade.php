...
@section('title', 'Edit Post Adopsi')
@section('content')
    @include('dashboard.flash.flash')
    <div class="col-md-12">
        <form action="{{ route('PostAdopsi.update',$PostAdopsi->id_post_adopsi) }}" method="post">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_post" id="nama_post" class="form-control" value="{{$PostAdopsi->nama_post}}">
            </div>
            <div class="form-group">
                <label for="nama_post">
                    <h5 class=""> Lokasi </h5>
                </label>
                <input type="text" name="lokasi" id="lokasi" class="form-control" value="{{$PostAdopsi->lokasi}}">
            </div>
            <div class="form-group">
                <label for="nama_post">
                    <h5 class=""> Syarat </h5>
                </label>
                <input type="text" name="syarat_adopsi" id="syarat" class="form-control" value="{{$PostAdopsi->syarat_adopsi}}">
            </div>
